          ...
          <td><table width="100%" border="0" cellspacing="0">
              <tr>
                <td><img src="images/buy2.gif" width="635" height="38" />
                  <p>亲爱的${sessionScope.user.uloginid }先生！欢迎您来到商城结算中心</p></td>
              </tr>
              <tr>
                ...
                <c:set var="sum" value="0"></c:set>
                 <c:if test="${cart!=null }">
				   ...
				   <p>收货地址：<input name="text" type="text" value="${sessionScope.user.uaddress }" style="width:350px"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">【确认】</a><br/>
				   收货人：&nbsp;&nbsp;&nbsp;&nbsp;<input name="text" type="text" value="${sessionScope.user.uloginid }" style="width:150px"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">【确认】</a><br/>
				   联系方式：<input name="text" type="text" value="${sessionScope.user.utel }" style="width:150px"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">【确认】</a>
				   
				   </p>
				  <hr/> 
				   <p style="text-align:right"><a href="${pageContext.request.contextPath}/cart.do?type=ofinal"><img src="${pageContext.request.contextPath}/images/gif53_029.gif" width="204" height="51" border="0" /></a></p></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
