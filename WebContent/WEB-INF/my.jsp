    ...
    <tr>
      <td width="25%"><table width="100%" border="0" cellspacing="0" style="margin-top:30px">
        ...
        <tr>
		  ...
		  <a href="${pageContext.request.contextPath }/User.do?type=modify">用户信息修改</a></td>
        </tr>
...
<tr>
      ...
      <td><div style="text-align:right; margin:5px 10px 5px 0px"><a href="${sessionScope.user.uloginid }/index.do">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a href="#">&nbsp;${sessionScope.user.uloginid }</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;欢迎 </div>
