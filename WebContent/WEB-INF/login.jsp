...
<table width="900px" border="0" cellspacing="0">
  <tr>
    <td style="padding:30px"><div style="height:470px"><b><a href="${pageContext.request.contextPath }/index.do">&nbsp;&nbsp;首页</a>&nbsp;&raquo;&nbsp;个人用户登录</b>
          <div>
              ...
              <tr>
                ...
                <td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
                  ...
                  <p style="text-align:right">
                    <a href="${pageContext.request.contextPath}/dispacher.do?type=reg"><img src="${pageContext.request.contextPath }/images/signupbutton.gif" width="135" height="33"/></a>
                  </p></td>
              </tr>
            </table>
          </div>
