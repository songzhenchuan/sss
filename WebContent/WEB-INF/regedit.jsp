...
window.onload = function(){
	document.querySelector('#img1').onclick=function(){
		this.src='${pageContext.request.contextPath }/Code.do?id='+Math.random();
	}
}
</script> -->
<body class="main">
...
<form action="${pageContext.request.contextPath }/regedit.do" method="post">
<div id="divcontent">
...
<table width="70%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td style="width:40%"><input type="text" name="uemail" class="textinput" id="uemail"/></td>
    <td><img src="images/check_use.gif" width="111" height="24" id="check_email"/><span id="spemail"></span></td>
  </tr>
  <tr>
...
<option value="您的第一辆汽车或自行车是什么牌子的？" >您的第一辆汽车或自行车是什么牌子的？</option>
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" name="sanswer" class="textinput"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <font color="#999999">不能少于4个字符，不区分大小写</font></td>
    </tr>
    <tr>
    <td style="text-align:right">备用邮箱：</td>
    <td><input type="text" name="ubackupemail" class="textinput"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
...
<table width="80%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td style="width:50%"><input type="text" name="ucheckcode" class="textinput"/></td>
    <td align="left" id="img2"><img id="img1" src="${pageContext.request.contextPath }/Code.do" alt=""></td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
    <td>&nbsp;</td>
